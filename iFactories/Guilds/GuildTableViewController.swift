...
protocol GuildSelectP {
    func guildSelected(guild: Guild)
}
class GuildTableViewController: UITableViewController {

    public var myGuilds = [Guild]()
    public var delegate: GuildSelectP?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let ser = myGuilds[indexPath.row] as? Guild
        {
            delegate?.guildSelected(guild: ser)
        }
    }
